(function (container, graphics) {
    ...
    prototype.load = function (application) {
        ...
        this.entities.cube = new factory.Mesh(cubeGeometry, cubeMaterial);
        this.entities.cube.position.set(0, 0, -5);
        scene.add(this.entities.cube);
    ...
    prototype.update = function () {
        this.entities.cube.rotation.x += 0.01;
        this.entities.cube.rotation.y += 0.01;
    };
